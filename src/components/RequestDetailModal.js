        ...
        <Paper className={classes.paper}>
            <Container>
                ...
                <div className={classes.actions}>
                    <Button variant="contained" color="primary" onClick={() => onClose('approved')} className={classes.button}>
                        Aceptar
                    </Button>
                    <Button variant="contained" color="secondary" onClick={() => onClose('rejected')} className={classes.button}>
                        Rechazar
                    </Button>
                </div>
            </Container>
